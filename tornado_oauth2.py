...
# -*- coding: utf-8 -*-
#
#  You should get tocken .
#curl -i http://localhost:8889/oauth/token -X GET -H 'Content-Type: application/json' -d '{"client_id": "abc", "client_secret": "xyz", "grant_type": "client_credentials", "scope": "foo"}'
#
# If You want to get information (Before use You should change token)
